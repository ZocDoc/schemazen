...
", DateTime.Today.ToString("MM-dd-yyyy"));
        ...
        private readonly string TurnOnParseOnly = "SET PARSEONLY ON";

        private readonly string TurnOffParaseOnly = "SET PARSEONLY OFF";
        ...
        [Test]
        public void TestCommentSyntaxIsValid() {
            DBHelper.ExecSql(_db.Connection, TurnOnParseOnly);
            DBHelper.ExecSql(_db.Connection, AutoGenerateComment);
            DBHelper.ExecSql(_db.Connection, TurnOffParaseOnly);
        }
